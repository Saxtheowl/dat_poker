...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	//__int64 timings, endtimings;	// for high precision timing
	...
	printf("\nValidation seconds = %.4lf\nSeconds per lookup = %lf\n", hftimer.getElapsedTimeInSec(), hftimer.getElapsedTimeInSec() /  133784560.0) ;
